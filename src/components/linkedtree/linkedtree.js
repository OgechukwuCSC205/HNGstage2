  ...
  return (
    <>
      <div className="App">
        ...
        <p id="twitter" className="profile-name">
          Yoma
        </p>
        ...
        <a href="http://books.zuri.team" id="books" className="button-link">
          ...
          <p className="sell-text">
            Want to learn more on design and code? Check out{" "}
            <span> Zuri Books</span>
          </p>
        </a>
        <a
          href="https://books.zuri.team/python-for-beginners?ref_id=yomata"
          id="book__python"
          className="button-link"
        >
          Python Books
          <p className="sell-text">
            Ever wanted to learn Python? Check out{" "}
            <span> Zuri Python Books</span>
          </p>
        </a>
        <a
        ...
        >
          ...
          <p className="sell-text">
            Wondering if Mark's a good and trustworthy programmer? Check out our
            website for doing background checks on coders
          </p>
        </a>
        <a
